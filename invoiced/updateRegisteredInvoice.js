...
module.exports = require('express').Router().post('/',async(req,res) => 
{
    try
    {
        ...
        totalItems = 0
        poMasterId = 0
        if(!req.body.uuid || !req.body.vendor || !req.body.vendor?.uuid || !req.body.barCode || !req.body.invoiceNumber || !req.body.invoiceDate || !req.body.baseAmount    || !req.body.discount || !req.body.gstAmount || !req.body.netAmount || req.body.invoiceDetails.length == 0)
        {
            res.status(400)
            return res.json({
                "status_code" : 400,
