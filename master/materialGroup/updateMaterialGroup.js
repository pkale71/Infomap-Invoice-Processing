...
module.exports = require('express').Router().post('/',async(req,res) => 
{
    try
    {
        ...
        if(uniqueCheck == 0)
        {
            ...
            let updateMaterialGroup = await db.updateMaterialGroup(uuid, code,  description, modifyOn, modifyById, isActive)
            if(updateMaterialGroup.affectedRows > 0)
            {
                res.status(200)
                return res.json({
                    "status_code" : 200,
            ...
            else
            {
                ...
                return res.json({
                    "status_code" : 500,
                    "message"     : "Material Group not updated",
