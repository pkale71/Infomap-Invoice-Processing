...
module.exports = require('express').Router().post('/',async(req,res) => 
{
    try
    {
        ...
        if(checkUsed[0].isExist == 0)
        {
            ...
            let deleteMaterialGroup = await db.deleteMaterialGroup(uuid, isActive, modifyOn, modifyById)
            if(deleteMaterialGroup.affectedRows > 0)
            {
                res.status(200)
                return res.json({
                    "status_code" : 200,
            ...
            else
            {
                ...
                return res.json({
                    "status_code" : 500,
                    "message"     : "Material Group not deleted",
        ...
        else
        {
            ...
            return res.json({
                "status_code" : 400,
                "message"     : "Material Group is already in use",
                "status_name" : getCode.getStatus(400)
            });
        }
    }
