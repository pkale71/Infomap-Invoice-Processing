...
module.exports = require('express').Router().post('/',async(req,res) => 
{
    try
    {
        ...
        if(uniqueCheck == 0)
        {
            ...
            let updateProfitCenter = await db.updateProfitCenter(uuid, code,  description, modifyOn, modifyById, isActive)
            if(updateProfitCenter.affectedRows > 0)
            {
                res.status(200)
                return res.json({
                    "status_code" : 200,
            ...
            else
            {
                ...
                return res.json({
                    "status_code" : 500,
                    "message"     : "Profit Center not updated",
